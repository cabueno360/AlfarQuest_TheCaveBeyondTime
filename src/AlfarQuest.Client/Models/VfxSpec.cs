...
///
/// Deliberately not configurable: sound. There is no sound system beyond the
/// level-up chime, and a field nothing reads would be a promise.</summary>
    ...
    float Vary = 0.5f)
{
    ...
    [
        ...
        new("hit_flesh",   ["#a8323c", "#7d2630", "#c0555c"], 7,  120, 0.35f, 3f,
            Emission.Cone, 1.5f, Gravity: 260f, Drag: 0.88f, Shake: 0.14f, HitStop: 0.035f),

        new("hit_stone",   ["#b8b6c8", "#8e8ba0", "#e0dcc8"], 9,  150, 0.40f, 2.5f,
            Emission.Cone, 1.4f, Gravity: 420f, Drag: 0.9f, Shake: 0.18f, HitStop: 0.04f),

        new("hit_metal",   ["#fff4d0", "#ffd77a", "#ffae3a"], 12, 220, 0.28f, 2f,
            Emission.Cone, 1.1f, Gravity: 320f, Drag: 0.86f, Additive: true, Shake: 0.2f, HitStop: 0.045f),

        new("hit_crystal", ["#9fe4ff", "#d6f2ff", "#5aa8d8"], 11, 180, 0.45f, 2.5f,
            Emission.Cone, 1.3f, Gravity: 300f, Drag: 0.9f, Additive: true, Shake: 0.16f, HitStop: 0.04f),

        new("hit_wood",    ["#c9a06a", "#8a6a42", "#e0c9a0"], 8,  140, 0.42f, 2.5f,
            Emission.Cone, 1.4f, Gravity: 380f, Drag: 0.9f, Shake: 0.12f, HitStop: 0.03f),
        ...
        new("death_magic", ["#c98fff", "#9fe4ff", "#e7ccff"], 22, 70, 1.1f, 3f,
            Emission.Ring, MathF.Tau, Gravity: -70f, Drag: 0.95f, Additive: true),
        ...
        new("dash_dust",   ["#d8c9a8", "#b8a684"], 10, 90, 0.5f, 3f,
            Emission.Cone, 1.8f, Gravity: 40f, Drag: 0.88f),

        new("water_step",  ["#9fd6ff", "#d6f2ff", "#6fa8d8"], 6, 70, 0.45f, 2.5f,
            Emission.Fountain, 1.4f, Gravity: 300f, Drag: 0.9f, Additive: true),

        // ---- magic, by school ----------------------------------------
        new("fire",        ["#ff8a3c", "#ffd06b", "#c0392b"], 26, 150, 0.6f, 4f,
            Emission.Ring, MathF.Tau, Gravity: -120f, Drag: 0.9f, Additive: true, Shake: 0.5f),

        new("holy",        ["#f0d99a", "#fff6d8", "#ffd77a"], 24, 110, 0.8f, 3.5f,
            Emission.Ring, MathF.Tau, Gravity: -90f, Drag: 0.94f, Additive: true, Shake: 0.4f),

        new("frost",       ["#bfe9ff", "#e8f7ff", "#7fb6ff"], 24, 130, 0.7f, 3f,
            Emission.Ring, MathF.Tau, Gravity: 60f, Drag: 0.92f, Additive: true, Shake: 0.4f),
        ...
        new("chest_open",  ["#f0d99a", "#ffd77a", "#fff4d0"], 14, 110, 0.7f, 3f,
            Emission.Fountain, 1.6f, Gravity: 280f, Drag: 0.9f, Additive: true, Shake: 0.12f),

        new("chest_rare",  ["#f0d99a", "#fff6d8", "#c98fff"], 30, 170, 1.0f, 4f,
            Emission.Ring, MathF.Tau, Gravity: -60f, Drag: 0.93f, Additive: true, Shake: 0.45f),

        new("mine",        ["#b8b6c8", "#8e8ba0", "#c9a06a"], 12, 160, 0.5f, 2.5f,
            Emission.Cone, 1.6f, Gravity: 460f, Drag: 0.9f, Shake: 0.2f, HitStop: 0.03f),

        new("gather",      ["#7fd694", "#a8f0be", "#4e9c5e"], 10, 80, 0.6f, 2.5f,
            Emission.Fountain, 1.8f, Gravity: 120f, Drag: 0.92f),
        ...
        new("block",       ["#cfd6ff", "#ffffff"], 8, 130, 0.3f, 2.5f,
            Emission.Cone, 1.2f, Gravity: 200f, Drag: 0.88f, Additive: true, Shake: 0.1f),
