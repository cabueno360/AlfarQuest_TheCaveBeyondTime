...
public class RFloat { public float x, y, life; public string text = "", c = "#ffffff"; public string? arg; public bool up; }
...
public class RHud
{
    ...
    public string speechName = "", speechLine = "";   // a party member speaking — non-blocking
