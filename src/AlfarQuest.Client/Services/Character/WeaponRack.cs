...
public static class WeaponRack
{
    ...
    [
        new() { Id = "sword_iron", Value = 100, Name = "Iron Sword", Slot = Slot.MainHand, Rarity = Rarity.Uncommon,
                Icon = "⚔", Weapon = WeaponType.Sword, DamageMin = 8, DamageMax = 14,
                Flavour = "Plain, honest, and sharp where it counts." },
        new() { Id = "sword_steel", Value = 240, Name = "Steel Sword", Slot = Slot.MainHand, Rarity = Rarity.Rare,
                Icon = "⚔", Weapon = WeaponType.Sword, DamageMin = 14, DamageMax = 22,
                Attributes = new() { Strength = 2 } },
        new() { Id = "axe_war", Value = 150, Name = "War Axe", Slot = Slot.MainHand, Rarity = Rarity.Uncommon,
                Icon = "🪓", Weapon = WeaponType.Axe, DamageMin = 12, DamageMax = 24,
                Flavour = "Slow to lift, worse to be under." },
        new() { Id = "spear_long", Value = 120, Name = "Long Spear", Slot = Slot.MainHand, Rarity = Rarity.Uncommon,
                Icon = "🔱", Weapon = WeaponType.Spear, DamageMin = 9, DamageMax = 16,
                Attributes = new() { Dexterity = 1 } },
        new() { Id = "hammer_iron", Value = 260, Name = "Iron Warhammer", Slot = Slot.MainHand, Rarity = Rarity.Rare,
        ...
        new() { Id = "bow_hunting", Value = 60, Name = "Hunting Bow", Slot = Slot.MainHand, Rarity = Rarity.Common,
                Icon = "🏹", Weapon = WeaponType.Bow, DamageMin = 5, DamageMax = 10 },
        new() { Id = "staff_oak", Value = 75, Name = "Oak Staff", Slot = Slot.MainHand, Rarity = Rarity.Common,
                Icon = "🪄", Weapon = WeaponType.Staff, DamageMin = 6, DamageMax = 12,
                Attributes = new() { Intelligence = 2 } },
        new() { Id = "daggers_twin", Value = 130, Name = "Twin Daggers", Slot = Slot.MainHand, Rarity = Rarity.Uncommon,
                Icon = "🗡", Weapon = WeaponType.Dagger, DamageMin = 5, DamageMax = 9,
                Attributes = new() { Agility = 1 }, Flavour = "Two quick words in the dark." },
        new() { Id = "sword_dawn", Value = 1400, Name = "Dawnbreaker", Slot = Slot.MainHand, Rarity = Rarity.Legendary,
